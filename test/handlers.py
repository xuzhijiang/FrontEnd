...
import time, hashlib, asyncio, logging, re, uuid
...
def authenticate(*, email, passwd):
	...
	if not passwd:
		raise ValueError('email', 'Invalid passwd.')
...
def api_create_comment(id, request, *, content):
	...
	comment = Comment(blog_id=blog.id, user_id=user.id, user_name=user.image, content=content.strip())
